			...
			<div id="main" class="wrapper style1">
				<div class="container">
					<div class="row">
						...
						<?php
											$company=$_SESSION['COMPANY']['company_name'];											?>
						<!-- Content -->
						<div id="content" class="8u skel-cell-important">
							<section>
								<header class="major">
									<h3 style="font-family:lucida handwriting;" align="center">-- Booking History for <?php echo $company?> -- </h3>
						   ...
						   $query=mysqli_query($con,"SELECT * FROM history where company='$company'");
