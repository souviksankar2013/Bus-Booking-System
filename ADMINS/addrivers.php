							...
							<section>
								<header class="major">
									...
									<div class="row uniform">
                                        ...
                                        <div class="6u 12u$(xsmall)" align="left" >
                                        <input type="text" name="company" id="company" style="border-radius:45px;" value="<?php 
...
if(isset($_POST['view']))
{
	...
	$query=mysqli_query($con,"SELECT * FROM driver where company_name like '$sea'");
	...
	if(mysqli_num_rows($query))
	{
        ...
        <table border="1" align="center" width="60%" height="auto" >
          ...
          <td style="padding:10px"><a onClick="return confirm('Are you sure you want to update Mr/Mrs.<?php echo $bag['name']?>?')" href="companyupdriver.php?id=<?php echo $bag['driverid']?>"><img src="2.png"></a></td>
