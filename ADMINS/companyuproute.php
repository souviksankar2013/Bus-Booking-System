									...
									<div class="row uniform">
                                        ...
                                        <div class="6u 12u$" align="left">
                                         ...
                                         <div class="6u 12u$(xsmall)" align="left" >
											...
											<input type="text" name="company_name" id="company_name" value="<?php echo $bag['company_name'];?>" placeholder="Company name:-" style="border-radius:45px;" readonly />
										</div>
...
$('.clockpicker').clockpicker();
                                        ...
                                        <div class="6u 12u$" align="left">
                                         <input data-provide="datepicker" name="bookstartdate" placeholder="Date of booking start (mm-dd-yyyy)" value="<?php echo $bag['bookstart'];?>" style="-moz-appearance: none;
                                         ...
                                         <div class="6u 12u$" align="left" >
                                         <input data-provide="datepicker" name="bookfinishdate" placeholder="Date of booking finish (mm-dd-yyyy)" value="<?php echo $bag['bookfinish'];?>" style="-moz-appearance: none;
		                                                   -webkit-appearance: none;
		                                                      -o-appearance: none;
		                                                       -ms-appearance: none;
		                                                         appearance: none;
