...
if(isset($_POST['view']))
{
	...
	$query=mysqli_query($con,"SELECT * FROM car where company_name = '$sea'");
	...
	if(mysqli_num_rows($query))
	{
        ...
        <table border="1" align="center" width="60%" height="auto" >
          ...
          <td style="padding:10px"><a onClick="return confirm('Are you sure you want to update ?')" href="companyupcar.php?id=<?php echo $bag['carid']?>"><img src="2.png"></a></td>
