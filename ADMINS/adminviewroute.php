									...
									<div class="row uniform">
                                        ...
                                        <div class="6u 12u$" align="left">
                                         ...
                                         <div class="6u 12u$(xsmall)" align="left" >
											...
											<input type="text" name="company_name" id="company_name" value="" placeholder="Company name:-" style="border-radius:45px;" />
										</div>
...
$('.clockpicker').clockpicker();
                                        ...
                                        <div class="6u 12u$" align="left">
                                         <input data-provide="datepicker" name="bookstart" placeholder="Date of booking start (mm-dd-yyyy)" style="-moz-appearance: none;
                                         ...
                                         <div class="6u 12u$" align="left" >
                                         <input data-provide="datepicker" name="bookfinish" placeholder="Date of booking finish (mm-dd-yyyy)" style="-moz-appearance: none;
		                                                   -webkit-appearance: none;
		                                                      -o-appearance: none;
		                                                       -ms-appearance: none;
		                                                         appearance: none;
			...
			$arrival=$_POST['arrival'];
					...
					if($source!= 0 || $destination!= 0 || $company_name!=0 || $cost!= 0 || $departure!= 0 || $carlicence!=0 || $arrival!=0 || $bookfinish!=0 || $bookstart !=0) {
					
		
			#insert into database
				
				
$insert=mysqli_query($con,"INSERT INTO route values('','$source','$destination','$cost','$company_name','$carlicence','$departure','$arrival','$bookstart','$bookfinish')") or die(mysqli_error($con));
			if($insert)
			{	
				?><script>
...
if(isset($_POST['view']))
{
	...
	if(mysqli_num_rows($query))
	{
        ...
        <table border="1" align="center" width="60%" height="auto" >
          ...
          <td style="padding:10px"><a onClick="return confirm('Are you sure you want to update ?')" href="adminuproute.php?id=<?php echo $bag['routeid']?>"><img src="2.png"></a></td>
