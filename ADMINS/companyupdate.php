...
<head>
    ...
    <?php  
				   ...
				   $update=mysqli_query($con,"SELECT * FROM admin where company_name like '$sea'") or die(mysqli_error($con));
...
<div id="content" class="8u skel-cell-important">
              ...
              <h5 style="font-family:Agency FB;" align="center"><marquee behavior="alternate" scrollamount="5"> You have automatically logged out after update </marquee> </h5>
									...
									<div class="row uniform">
                                        ...
                                        <br> <br> <br> <br>
                                        <div class="12u 12u$(xsmall)" align="left">Upload Company Photo:
			...
			
{
				...
				if($file_type == "image/jpeg" || $file_type == "image/png" || $file_type == "image/jpg" || $file_type == "image/JPG" || $file_type == "image/PNG" || $file_type == "image/JPEG")
   {
				...
				if($up)
		{
$insert=mysqli_query($con,"UPDATE admin SET name= '$aname',email = '$email',company_name = '$company_name',type='$type',fpath='$server_path' where company_name like '$sea'") or die(mysqli_error($con));
			if($insert)
			   {	
				?><script>				alert(' Update Successfull && You have automatically logged out !!!')
        		                </script>				<?php
	...
	window.location.href = 'index.php'; </script>
     <?php
			...
			
			{
				...
				$insert1 = mysqli_query($con,"UPDATE admin SET name= '$aname',email = '$email',company_name = '$company_name',type='$type' where company_name like '$sea'") or die(mysqli_error($con));
			if($insert1)
			  {
				?><script>
	...
	session_start();
	session_destroy();
	?><script>alert("You have automatically logged out");
	window.location.href = 'index.php'; </script>
     <?php
