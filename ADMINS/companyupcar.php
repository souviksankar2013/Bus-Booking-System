...
{ 
	...
	$view_user=mysqli_query($con,"SELECT * FROM car WHERE carid = '$id' AND company_name='$company_name'") or die(mysqli_error($con));
							...
							<section>
								<header class="major">
									...
									<div class="row uniform">
                                        ...
                                        <div class="6u 12u$(xsmall)" align="left" >
                                         <input type="text" name="company" id="company" value="<?php echo $bag['company_name']?>" style="border-radius:45px;" readonly />
										</div>
...
if(isset($_POST['submit']))
{
	...
	$carlicence = $_POST['carlicence'];
			...
			$update = mysqli_query($con,"UPDATE car SET name = '$name',type = '$type',licenceno = '$licence',seat = '$seat',driverid = '$driver' WHERE carid = '$id'") or die(mysqli_error($con));
